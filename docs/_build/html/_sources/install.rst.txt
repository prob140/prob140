...
After everything is installed, you can use `pip` to install Python packages. Using `pip`,
install the `prob140` library::
...
You should also have the following Python packages, which might have already been installed
by one of the previous installations. Install them with `pip`:
